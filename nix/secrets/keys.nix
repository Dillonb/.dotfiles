{
  ...
  host = {
    ...
    "dulu" = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFh97wdv2x0TtxnzPU6ZfdNAeleY7RvtV/f6lrTHfyQA";
    "teamspeak-server" =
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGRAJwoisf2XTjW2lrGo4WcGV7gkBi3ryxDs8NZ6XKiv";
    "pi4" = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILOeEvZymnFYVFnwWj1a/ys2e4yGaOH9S/fLblbrJw7Z";
    "dgbmbp-nixos-vm" =
  ...
  user = {
    ...
    "bc250" = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGxBH4YU3aJlJKmUA6OFhaFeKoSZHPJT4711A2H4WEaR";
  };
}
